...
var uiController = (function () {
    ...
    return {
        ...
        tusviigUzuuleh: function (tusuv) {
            ...
            document.querySelector(DOMstring.expeseLabel).textContent = tusuv.totalExp;
        ...
        addListItem: function (item, type) {
            ...
            if (type === "inc") {
                ...
                html = '<div class="item clearfix" id="exp-%id%"><div class="item__description">$$DESCRIPTION$$</div><div class="right clearfix"><div class="item__value">- $$VALUE$$</div><div class="item__percentange">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>'
            }
    ...
    var setupEventListeners = function () {
        ...
        document.querySelector(DOM.containerDiv).addEventListener("click", function (event) {
            ...
            if (id) {
                ...
                // 2. Дэлгэц дээрээс энэ элементыг устгана
